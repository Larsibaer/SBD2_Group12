...
boxplot(scale(data_under_num), main = "Boxplot with outliers", xaxt = "n")
...
boxplot(scale(data_under_num_removed),main = "Boxplot with cleaned outliers", xaxt = "n")
...
```{r}
for (i in 1:length(data_under_removed[,-c(12:17)])) {
  print(ggplot(data_under, aes(y = data_under_removed[,i], color = Status)) + 
  geom_boxplot() + 
  ylab(names(data_under_removed[i])) + 
